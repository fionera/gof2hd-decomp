#ifndef WORK_CLASSES_NOTEXVTXCOLORSHADER_SRC_CLASS_H
#define WORK_CLASSES_NOTEXVTXCOLORSHADER_SRC_CLASS_H
...
extern "C" char _ZTVN11AbyssEngine19NoTexVtxColorShaderE[];
