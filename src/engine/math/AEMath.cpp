...
// Fast inverse square root (one Newton-Raphson iteration on the classic bit-twiddle estimate).
...
// Re-pack the engine's row-major 3x4 transform into a column-major GL 4x4 matrix.
