...
#include "engine/math/Vector.h"              // AbyssEngine::AEMath::Vector (value type)
#include "engine/math/Matrix.h"              // AbyssEngine::AEMath::Matrix (value type)
#include "engine/core/AEString.h"            // AbyssEngine::String (deleted by ReleaseClasses)
