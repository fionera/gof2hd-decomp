...
// Galaxy on Fire 2 -- ListItemWindow.
// A list-detail sub-window: shows the label/value rows for the currently
// selected ListItem, and for ship items a rotating 3D ship preview the player
// can spin with touch. Owns its two String-row arrays, two ship-stat int
// arrays, the inner scroll window and the preview geometry.
