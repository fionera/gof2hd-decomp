...
// ---- ABI bridges for not-yet-migrated callers (Level.cpp / MGame.cpp) -------
// These mirror the construct/destruct entry points those translation units still
// reference by symbol; they simply forward to the real ctor/dtor.
