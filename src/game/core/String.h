...
// src/String.cpp; the bodies operate on the std::u16string member, not raw byte offsets.

// The recovered, ABI-stable C entry points for AbyssEngine::String. All take `String*` (the
// common.h std::u16string-backed type) and manipulate its `s` member.
extern "C" {
