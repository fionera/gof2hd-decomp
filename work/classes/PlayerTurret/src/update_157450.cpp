...
void PlayerTurret::update(int delta)
{
    ...
    if (hp < 1 && (uint32_t)(state - 3) >= 2) {
        ...
        ParticleSystemManager_emitManual(I(P(this, 0x54), 0x74), I(P(this, 0x54), 0x3c),
                                         (Vector *)B(this, 0x2c), &zero, value);
        ParticleSystemManager_enableSystemEmit(I(P(this, 0x54), 0x74), I(this, 0x138), 1);
        ...
        if (random < 0) {
            ...
            ArrayAdd_int(AERandom_nextInt(*gPlayerTurretRandom, 10) + 1, (IntArray *)P(this, 0x50));
            KIPlayer_createCrate(this, 3);
            UC(this, 0x4c) = 1;
        } else {
            int levelPlayer = Level_getPlayer((Level *)P(this, 0x54));
            if (levelPlayer != 0) {
                levelPlayer = Level_getPlayer((Level *)P(this, 0x54));
    ...
    if (state == 3) {
        ...
        if (I(this, 0x12c) > 4500) {
            ParticleSystemManager_enableSystemEmit(I(P(this, 0x54), 0x74), I(this, 0x138), 0);
            I(this, 0x12c) = 0;
            I(this, 0x88) = 4;
            Player_setActive(player, false);
            if (UC(this, 0x3f) != 0) {
                I(P(this, 0x54), 0x6c) = I(P(this, 0x54), 0x6c) - 1;
            }
        }
        return;
    }
    ...
    } else if (UC(this, 0x25) != 0 && P(this, 0x144) != 0) {
        handleTurret(delta);
    }
}
