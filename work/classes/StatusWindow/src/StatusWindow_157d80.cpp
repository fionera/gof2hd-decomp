...
extern "C" StatusWindow *StatusWindow_ctor(StatusWindow *self)
{
    ...
    *(void **)(*(int *)((char *)self + 0x4) + 4) = b1;
    ...
    self->f_10 = 0;
    self->f_78 = *(int *)((char *)layout + 0x84);
    self->f_34 = -1;
    ...
    self->f_70 = PaintCanvas_GetImage2DWidth(canvas) / 2;
    ...
    int row = ((*(int *)((char *)layout + 0x1c) * 3 + *(int *)((char *)layout + 0x2d8)) +
               *(int *)((char *)layout + 0x2c) * 8) + self->f_64 +
               *(int *)((char *)layout + 0x4) * 7;
    heights[0] = row;

    int lineH;
    if (*g_sw_tabIndex == 0) {
        lineH = self->f_78 * __aeabi_idiv(self->f_0, 3);
    } else {
        lineH = __aeabi_idiv(self->f_0, 3) * self->f_78 +
                *(int *)((char *)layout + 0x1c) + *(int *)((char *)layout + 0x2c);
    }
    heights[1] = lineH + 10;

    self->f_58 = heights[self->f_30];
    self->f_5c =
