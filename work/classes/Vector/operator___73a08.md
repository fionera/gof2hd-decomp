...
## target disasm
```
  00083a08: beq 0x000bf050
  00083a0c: bcc 0x000bf058
  00083a10: bne 0x000ff058
  00083a14: beq 0x000bf2a8
  00083a18: bcs 0x0013f060
  00083a1c: beq 0x000bf024
  00083a20: beq 0x000ff06c
  00083a24: beq 0x000ff2ac
  00083a28: beq 0x000ff030
  00083a2c: beq 0x0013f078
  00083a30: beq 0x0013f2b8
  00083a34: beq 0x0013f03c
  00083a38: ldc p7,cr4,[r0,#0x1c0]
  00083a3c: vmla.f32 s0,s6,s0
  00083a40: vldr.32 s2,[r0,#0x40]
  00083a44: vldr.32 s2,[r0,#0x4]
  00083a48: vdiv.f32 s4,s0,s4
  00083a4c: vdiv.f32 s0,s2,s6
  00083a50: vdiv.f32 s2,s4,s6
  00083a54: vstr.32 s4,[r0,#0xc]
  00083a58: vstr.32 s0,[r0]
  00083a5c: vstr.32 s2,[r0,#0x4]
  00083a60: ldrbmi r2,[r0,-r2,lsl #0x14]!
  000bf050: bl 0x00bfcf24
  000bf054: teqhip r8,r11, asr #0x11
  000ff058: andeq r3,lr,r9, lsr r1
  000ff05c: swilt 0x800000
  000ff06c: eorgt r1,r3,#0x880
  0013f03c: stmdavs r0!,{r0,r1,r2,r3,r7,pc}
  0013f040: swi 0xf8f732
  0013f044: ldcl p7,cr15,[r0],#-0xd8
  0013f060: bfieq r9,r6,#0x10,#-0xf
  0013f078: rsble r2,pc,r0, lsl #0x10
  0013f07c: stmdavs r0,{r3,r4,r11,r12,pc}
  0013f2b8: andcs r12,r0,#0x18000001
  0013f2bc: stmdbls r1!,{r8,r9,sp}
  0013f2c0: beq 0x0017a8fc
  0013f2c4: stcl p7,cr15,[r10,#-0xcc]!
```
