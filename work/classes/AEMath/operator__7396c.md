...

{
  ...
  coprocessor_load(7,in_cr4,this + 0x1c0);
  *(float *)(this + 8) = in_s4;
  *(float *)(this + 4) = *(float *)param_1 + *(float *)this + in_s2;
  *(float *)(this + 8) = *(float *)(param_1 + 4) + in_s4;
  if (in_NG) {
    this = (Vector *)(uint)(byte)this[in_r2 * -0x100000];
  }
  if (!in_ZR) {
    if (!in_CY) {
      if (in_NG) {
...
## target disasm
```
  0008396c: andvs r6,r2,r10, lsl #0x10
  00083970: subvs r6,r2,r10, asr #0x10
  00083974: addvs r6,r1,r9, lsl #0x11
  00083978: ldc p7,cr4,[r0,#0x1c0]
  0008397c: vldr.32 s0,[r1]
  00083980: vldr.32 s6,[r0]
  00083984: vadd.f32 s2,s6,s2
  00083988: vldr.32 s0,[r0]
  0008398c: vstr.32 s4,[r0,#0x8]
  00083990: vldr.32 s0,[r1]
  00083994: vadd.f32 s0,s0,s2
  00083998: vstr.32 s0,[r0,#0x4]
  0008399c: vldr.32 s0,[r1,#0x4]
  000839a0: vadd.f32 s0,s0,s4
  000839a4: vstr.32 s0,[r0,#0x8]
  000839a8: ldrbmi r0,[r0,-r2,lsl #0x14]!
```
