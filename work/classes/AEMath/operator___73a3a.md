...
elf 0x73a3a body 1
Sig: undefined __thiscall operator/=(Vector * this, float param_1)
...

{
  ...
  if (in_NG) {
    *(undefined4 *)(unaff_r5 + -4) = 0xbf08a;
    *(undefined4 *)(unaff_r5 + -8) = in_r12;
    *(undefined4 *)(unaff_r5 + -0xc) = unaff_r11;
    *(undefined4 *)(unaff_r5 + -0x10) = in_r3;
    *(undefined4 *)(unaff_r5 + -0x14) = in_r1;
  }
                    /* WARNING: Bad instruction - Truncating control flow here */
  halt_baddata();
}
