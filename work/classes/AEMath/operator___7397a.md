...
undefined4 __thiscall AbyssEngine::AEMath::Vector::operator+=(Vector *this,Vector *param_1)

{
  undefined2 *puVar1;
  ResourceTexture *this_00;
  Vector *pVVar2;
  int extraout_r1;
  int *unaff_r4;
  code *pcVar3;
  ...
  if (!in_ZR) {
    ...
    puVar1 = operator_new((uint)this);
    this_00 = operator_new(8);
    ResourceTexture::ResourceTexture(this_00,(char *)(DAT_000fefe8 + 0xfefe4),extraout_s0);
    *puVar1 = 0x27ab;
                    /* WARNING: Bad instruction - Truncating control flow here */
    halt_baddata();
  }
  ...
  String::~String((String *)(unaff_r7 + -0x5c));
  String::~String((String *)(unaff_r7 + -0x68));
  this_01 = (Galaxy *)**(undefined4 **)(DAT_0017d0ec + 0x17cf2c);
  iVar4 = Agent::getSellSystemIndex(unaff_r9);
  Galaxy::getSystem(this_01,iVar4);
  uVar7 = *unaff_r10;
  ...
  Status::replaceHash(unaff_r7 + -0x5c,uVar7,&stack0x000000f4,&stack0x000000e8);
  String::operator=((String *)(unaff_r7 + -0x38),(String *)(unaff_r7 + -0x5c));
  ...
  Status::replaceHash(unaff_r7 + -0x5c,uVar7,&stack0x000000d0,&stack0x000000c4);
  String::operator=((String *)(unaff_r7 + -0x38),(String *)(unaff_r7 + -0x5c));
  (*pcVar3)(unaff_r7 + -0x5c);
