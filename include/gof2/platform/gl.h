...
// OpenGL ES 2.0 entry points used by the engine. These are external platform symbols (provided by
// the GLES driver / host GL layer), declared here once so no translation unit redeclares them.
extern "C" {
...
// state / buffers / textures / framebuffers
