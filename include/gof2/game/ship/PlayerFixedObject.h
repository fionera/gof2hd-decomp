...
#include "gof2/game/world/Station.h"   // provides the single shared `struct String`
...
// `struct String` (3-word by-value String ABI aggregate) is provided by gof2/Station.h.
