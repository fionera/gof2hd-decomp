...
// Galaxy on Fire 2 - WantedWindow: the bounty-board UI. Lists the wanted criminals
// available at the current station, shows the selected target's detail panel, and
// (when a bounty mission is started) hosts the embedded star map for plotting the route.

#include <cstdint>
#include "gof2/common.h"   // String, Array<T>
