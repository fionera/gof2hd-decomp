...
Current numbers (of **4523** compared): **byte_exact 1159, linked_exact 2567, avg 77.50%**.
...
`tools/sodiff_allow.txt`, undefined-import set pinned (673 names; a typo'd callee is a hard
