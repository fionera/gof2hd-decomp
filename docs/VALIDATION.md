...
Current numbers (of **4523** compared): **byte_exact 1160, linked_exact 2577, avg 77.56%**.
...
`tools/sodiff_allow.txt`, undefined-import set pinned (660 names; a typo'd callee is a hard
