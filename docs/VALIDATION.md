...
Current numbers (of **4523** compared): **byte_exact 1167, linked_exact 2667, avg 78.07%**.
...
`tools/sodiff_allow.txt`, undefined-import set pinned (601 names; a typo'd callee is a hard
