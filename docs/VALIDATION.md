...
Current numbers (of **4523** compared): **byte_exact 1159, linked_exact 2566, avg 77.48%**.
...
`tools/sodiff_allow.txt`, undefined-import set pinned (680 names; a typo'd callee is a hard
