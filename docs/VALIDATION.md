...
Current numbers (of **4523** compared): **byte_exact 1159, linked_exact 2565, avg 77.44%**.
...
`tools/sodiff_allow.txt`, undefined-import set pinned (685 names; a typo'd callee is a hard
