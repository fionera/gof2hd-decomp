...
Current numbers (of **4523** compared): **byte_exact 1161, linked_exact 2624, avg 77.89%**.
...
`tools/sodiff_allow.txt`, undefined-import set pinned (612 names; a typo'd callee is a hard
