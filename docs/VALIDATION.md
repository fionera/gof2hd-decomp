...
Current numbers (of **4523** compared): **byte_exact 1183, linked_exact 2757, avg 78.73%**.
...
`tools/sodiff_allow.txt`, undefined-import set pinned (596 names; a typo'd callee is a hard
