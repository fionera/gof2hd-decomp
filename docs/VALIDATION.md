...
Current numbers (of **4523** compared): **byte_exact 1160, linked_exact 2593, avg 77.66%**.
...
`tools/sodiff_allow.txt`, undefined-import set pinned (649 names; a typo'd callee is a hard
