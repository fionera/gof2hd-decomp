...
Current numbers (of **4523** compared): **byte_exact 1161, linked_exact 2628, avg 77.93%**.
...
`tools/sodiff_allow.txt`, undefined-import set pinned (607 names; a typo'd callee is a hard
