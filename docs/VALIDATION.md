...
Current numbers (of **4523** compared): **byte_exact 1159, linked_exact 2560, avg 77.37%**.
...
`tools/sodiff_allow.txt`, undefined-import set pinned (705 names; a typo'd callee is a hard
