...
Current numbers (of **4523** compared): **byte_exact 1160, linked_exact 2600, avg 77.79%**.
...
`tools/sodiff_allow.txt`, undefined-import set pinned (620 names; a typo'd callee is a hard
