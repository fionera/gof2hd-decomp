...
Current numbers (of **4523** compared): **byte_exact 1161, linked_exact 2623, avg 77.85%**.
...
`tools/sodiff_allow.txt`, undefined-import set pinned (619 names; a typo'd callee is a hard
