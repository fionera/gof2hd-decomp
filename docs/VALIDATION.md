...
Current numbers (of **4523** compared): **byte_exact 1160, linked_exact 2584, avg 77.64%**.
...
`tools/sodiff_allow.txt`, undefined-import set pinned (655 names; a typo'd callee is a hard
