...
## Update 2026-07-26 — current truth (supersedes the numbers below)
...
mode). Current: **compared 4523, byte_exact 1161, linked_exact 2628, avg 77.95%, stub_zero_size
0, missing 0, sodiff extra 52 (all allowlisted), undefined imports 602**. Historical figures in the sections below
...
byte-identicality were established from the original source-layout dumps
